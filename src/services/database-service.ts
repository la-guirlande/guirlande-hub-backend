...
import createModuleModel, { ModuleModel } from '../models/module-model';
...
export default class DatabaseService extends Service {
  ...
  public readonly modules: ModuleModel;
  ...
  public constructor(container: ServiceContainer) {
    ...
    this.modules = createModuleModel(container, this.mongoose);
  }
